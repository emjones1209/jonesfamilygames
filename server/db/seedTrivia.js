...
// More geography (added September 2026 to cut down on repeats)
const GEOGRAPHY_MORE = [
  // Easy
  { category:'geography', difficulty:'easy', question:'What is the capital of Italy?', correct_answer:'Rome', wrong_answers:['Milan','Venice','Florence'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Spain?', correct_answer:'Madrid', wrong_answers:['Barcelona','Seville','Valencia'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Germany?', correct_answer:'Berlin', wrong_answers:['Munich','Frankfurt','Hamburg'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of the United Kingdom?', correct_answer:'London', wrong_answers:['Edinburgh','Manchester','Birmingham'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Egypt?', correct_answer:'Cairo', wrong_answers:['Alexandria','Giza','Luxor'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Mexico?', correct_answer:'Mexico City', wrong_answers:['Guadalajara','Monterrey','Cancún'] },
  { category:'geography', difficulty:'easy', question:'Machu Picchu is in which country?', correct_answer:'Peru', wrong_answers:['Mexico','Chile','Bolivia'] },
  { category:'geography', difficulty:'easy', question:'Which is the largest U.S. state by area?', correct_answer:'Alaska', wrong_answers:['Texas','California','Montana'] },
  { category:'geography', difficulty:'easy', question:'Which is the smallest U.S. state by area?', correct_answer:'Rhode Island', wrong_answers:['Delaware','Connecticut','New Jersey'] },
  { category:'geography', difficulty:'easy', question:'On which continent is Egypt?', correct_answer:'Africa', wrong_answers:['Asia','Europe','South America'] },
  { category:'geography', difficulty:'easy', question:'Which ocean lies between Africa and Australia?', correct_answer:'The Indian Ocean', wrong_answers:['The Atlantic Ocean','The Pacific Ocean','The Southern Ocean'] },
  { category:'geography', difficulty:'easy', question:'On which continent is most of the Amazon rainforest?', correct_answer:'South America', wrong_answers:['Africa','Asia','North America'] },
  { category:'geography', difficulty:'easy', question:'Which country is shaped like a boot?', correct_answer:'Italy', wrong_answers:['Greece','Portugal','Chile'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of China?', correct_answer:'Beijing', wrong_answers:['Shanghai','Hong Kong','Guangzhou'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Russia?', correct_answer:'Moscow', wrong_answers:['St. Petersburg','Kyiv','Minsk'] },
  { category:'geography', difficulty:'easy', question:'The Statue of Liberty stands in which U.S. city?', correct_answer:'New York City', wrong_answers:['Boston','Philadelphia','Washington, D.C.'] },
  { category:'geography', difficulty:'easy', question:'Mount Rushmore is in which U.S. state?', correct_answer:'South Dakota', wrong_answers:['North Dakota','Wyoming','Montana'] },
  { category:'geography', difficulty:'easy', question:'Which country is called the "Land of the Rising Sun"?', correct_answer:'Japan', wrong_answers:['China','South Korea','Thailand'] },
  { category:'geography', difficulty:'easy', question:'Which is the largest continent?', correct_answer:'Asia', wrong_answers:['Africa','North America','Europe'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Ireland?', correct_answer:'Dublin', wrong_answers:['Belfast','Cork','Galway'] },
  { category:'geography', difficulty:'easy', question:'The Grand Canyon is in which U.S. state?', correct_answer:'Arizona', wrong_answers:['Utah','Nevada','Colorado'] },
  { category:'geography', difficulty:'easy', question:'Which river flows through London?', correct_answer:'The Thames', wrong_answers:['The Seine','The Severn','The Tyne'] },
  { category:'geography', difficulty:'easy', question:'Which river flows through Paris?', correct_answer:'The Seine', wrong_answers:['The Loire','The Rhône','The Rhine'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Greece?', correct_answer:'Athens', wrong_answers:['Sparta','Thessaloniki','Corinth'] },
  { category:'geography', difficulty:'easy', question:'Which South American country has the most people?', correct_answer:'Brazil', wrong_answers:['Argentina','Colombia','Peru'] },
  { category:'geography', difficulty:'easy', question:'Niagara Falls lies on the border between the United States and which country?', correct_answer:'Canada', wrong_answers:['Mexico','Cuba','Greenland'] },
  { category:'geography', difficulty:'easy', question:'Which U.S. state is made up entirely of islands in the Pacific Ocean?', correct_answer:'Hawaii', wrong_answers:['Alaska','California','Oregon'] },
  { category:'geography', difficulty:'easy', question:'Which is the coldest continent?', correct_answer:'Antarctica', wrong_answers:['Europe','Asia','North America'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of India?', correct_answer:'New Delhi', wrong_answers:['Mumbai','Kolkata','Bangalore'] },
  { category:'geography', difficulty:'easy', question:'What is the capital of Argentina?', correct_answer:'Buenos Aires', wrong_answers:['Santiago','Montevideo','Córdoba'] },

  // Medium
  { category:'geography', difficulty:'medium', question:'What is the capital of Norway?', correct_answer:'Oslo', wrong_answers:['Stockholm','Copenhagen','Bergen'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Portugal?', correct_answer:'Lisbon', wrong_answers:['Porto','Coimbra','Madrid'] },
  { category:'geography', difficulty:'medium', question:'What is the highest mountain in Africa?', correct_answer:'Mount Kilimanjaro', wrong_answers:['Mount Kenya','Mount Stanley','Ras Dashen'] },
  { category:'geography', difficulty:'medium', question:'What is the longest mountain range above sea level?', correct_answer:'The Andes', wrong_answers:['The Rocky Mountains','The Himalayas','The Ural Mountains'] },
  { category:'geography', difficulty:'medium', question:'What is the largest hot desert in the world?', correct_answer:'The Sahara', wrong_answers:['The Arabian Desert','The Kalahari','The Gobi'] },
  { category:'geography', difficulty:'medium', question:'Which canal links the Mediterranean Sea with the Red Sea?', correct_answer:'The Suez Canal', wrong_answers:['The Panama Canal','The Corinth Canal','The Kiel Canal'] },
  { category:'geography', difficulty:'medium', question:'What is the largest country in Africa by area?', correct_answer:'Algeria', wrong_answers:['Democratic Republic of the Congo','Sudan','Libya'] },
  { category:'geography', difficulty:'medium', question:'What is the longest river in Europe?', correct_answer:'The Volga', wrong_answers:['The Danube','The Rhine','The Dnieper'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Scotland?', correct_answer:'Edinburgh', wrong_answers:['Glasgow','Aberdeen','Inverness'] },
  { category:'geography', difficulty:'medium', question:'The Galápagos Islands belong to which country?', correct_answer:'Ecuador', wrong_answers:['Peru','Chile','Colombia'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Vietnam?', correct_answer:'Hanoi', wrong_answers:['Ho Chi Minh City','Hue','Da Nang'] },
  { category:'geography', difficulty:'medium', question:'Which strait separates Asia from North America?', correct_answer:'The Bering Strait', wrong_answers:['The Strait of Magellan','The Davis Strait','The Strait of Hormuz'] },
  { category:'geography', difficulty:'medium', question:'What is the largest lake in Africa?', correct_answer:'Lake Victoria', wrong_answers:['Lake Tanganyika','Lake Malawi','Lake Chad'] },
  { category:'geography', difficulty:'medium', question:'Which of the Great Lakes is the largest?', correct_answer:'Lake Superior', wrong_answers:['Lake Michigan','Lake Huron','Lake Erie'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Peru?', correct_answer:'Lima', wrong_answers:['Cusco','Quito','La Paz'] },
  { category:'geography', difficulty:'medium', question:'Which sea lies between Italy and the Balkan Peninsula?', correct_answer:'The Adriatic Sea', wrong_answers:['The Aegean Sea','The Ionian Sea','The Tyrrhenian Sea'] },
  { category:'geography', difficulty:'medium', question:'Which river flows into the Sea of Galilee from the north?', correct_answer:'The Jordan River', wrong_answers:['The Yarmuk River','The Litani River','The Orontes River'] },
  { category:'geography', difficulty:'medium', question:'Where is the lowest point on dry land on Earth?', correct_answer:'The shore of the Dead Sea', wrong_answers:['Death Valley','Lake Assal','The Turpan Depression'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Poland?', correct_answer:'Warsaw', wrong_answers:['Kraków','Gdańsk','Prague'] },
  { category:'geography', difficulty:'medium', question:'Which U.S. state is known as the "Lone Star State"?', correct_answer:'Texas', wrong_answers:['Alaska','Tennessee','Montana'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Chile?', correct_answer:'Santiago', wrong_answers:['Valparaíso','Lima','Buenos Aires'] },
  { category:'geography', difficulty:'medium', question:'Victoria Falls is on which African river?', correct_answer:'The Zambezi', wrong_answers:['The Limpopo','The Congo','The Orange'] },
  { category:'geography', difficulty:'medium', question:'The Hagia Sophia stands in which city?', correct_answer:'Istanbul', wrong_answers:['Athens','Rome','Ankara'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Hungary?', correct_answer:'Budapest', wrong_answers:['Vienna','Prague','Bucharest'] },
  { category:'geography', difficulty:'medium', question:'What is the largest island off the east coast of Africa?', correct_answer:'Madagascar', wrong_answers:['Zanzibar','Mauritius','Socotra'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Saudi Arabia?', correct_answer:'Riyadh', wrong_answers:['Jeddah','Mecca','Medina'] },
  { category:'geography', difficulty:'medium', question:'Mont Blanc is the highest peak of which mountain range?', correct_answer:'The Alps', wrong_answers:['The Pyrenees','The Apennines','The Carpathians'] },
  { category:'geography', difficulty:'medium', question:'The Panama Canal links the Atlantic Ocean with which ocean?', correct_answer:'The Pacific Ocean', wrong_answers:['The Indian Ocean','The Arctic Ocean','The Southern Ocean'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Denmark?', correct_answer:'Copenhagen', wrong_answers:['Stockholm','Oslo','Aarhus'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Kenya?', correct_answer:'Nairobi', wrong_answers:['Mombasa','Kampala','Addis Ababa'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Colombia?', correct_answer:'Bogotá', wrong_answers:['Medellín','Cartagena','Caracas'] },
  { category:'geography', difficulty:'medium', question:'Which desert covers much of southern Mongolia and northern China?', correct_answer:'The Gobi', wrong_answers:['The Taklamakan','The Karakum','The Thar'] },
  { category:'geography', difficulty:'medium', question:'Which river flows through Rome?', correct_answer:'The Tiber', wrong_answers:['The Arno','The Po','The Adige'] },
  { category:'geography', difficulty:'medium', question:'What is the capital of Austria?', correct_answer:'Vienna', wrong_answers:['Salzburg','Graz','Budapest'] },
  { category:'geography', difficulty:'medium', question:'The Cliffs of Moher are in which country?', correct_answer:'Ireland', wrong_answers:['Scotland','Wales','England'] },

  // Hard
  { category:'geography', difficulty:'hard', question:'What is the capital of Mongolia?', correct_answer:'Ulaanbaatar', wrong_answers:['Astana','Bishkek','Tashkent'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Nigeria?', correct_answer:'Abuja', wrong_answers:['Lagos','Kano','Ibadan'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of the Canadian province of British Columbia?', correct_answer:'Victoria', wrong_answers:['Vancouver','Kelowna','Surrey'] },
  { category:'geography', difficulty:'hard', question:'What is the longest river in Asia?', correct_answer:'The Yangtze', wrong_answers:['The Yellow River','The Mekong','The Ob'] },
  { category:'geography', difficulty:'hard', question:'Which city is the world\'s highest seat of national government?', correct_answer:'La Paz', wrong_answers:['Quito','Bogotá','Addis Ababa'] },
  { category:'geography', difficulty:'hard', question:'The ruins of ancient Babylon lie in which modern country?', correct_answer:'Iraq', wrong_answers:['Iran','Syria','Kuwait'] },
  { category:'geography', difficulty:'hard', question:'The ruins of Nineveh lie across the river from which modern city?', correct_answer:'Mosul', wrong_answers:['Baghdad','Basra','Erbil'] },
  { category:'geography', difficulty:'hard', question:'The ruins of Persepolis are in which modern country?', correct_answer:'Iran', wrong_answers:['Iraq','Afghanistan','Syria'] },
  { category:'geography', difficulty:'hard', question:'The island of Patmos, where John received the Revelation, belongs to which country?', correct_answer:'Greece', wrong_answers:['Turkey','Cyprus','Italy'] },
  { category:'geography', difficulty:'hard', question:'According to Acts, on which island was Paul shipwrecked?', correct_answer:'Malta', wrong_answers:['Crete','Cyprus','Sicily'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Ethiopia?', correct_answer:'Addis Ababa', wrong_answers:['Asmara','Khartoum','Nairobi'] },
  { category:'geography', difficulty:'hard', question:'What is the world\'s largest landlocked country?', correct_answer:'Kazakhstan', wrong_answers:['Mongolia','Chad','Niger'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Morocco?', correct_answer:'Rabat', wrong_answers:['Casablanca','Marrakesh','Fez'] },
  { category:'geography', difficulty:'hard', question:'Which strait connects the Black Sea to the Sea of Marmara?', correct_answer:'The Bosporus', wrong_answers:['The Dardanelles','The Kerch Strait','The Strait of Otranto'] },
  { category:'geography', difficulty:'hard', question:'What is the deepest known point in the oceans, in the Mariana Trench?', correct_answer:'The Challenger Deep', wrong_answers:['The Horizon Deep','The Milwaukee Deep','The Sirena Deep'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Pakistan?', correct_answer:'Islamabad', wrong_answers:['Karachi','Lahore','Rawalpindi'] },
  { category:'geography', difficulty:'hard', question:'The Atacama Desert, one of the driest places on Earth, lies mainly in which country?', correct_answer:'Chile', wrong_answers:['Peru','Argentina','Bolivia'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Kentucky?', correct_answer:'Frankfort', wrong_answers:['Louisville','Lexington','Bowling Green'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of South Dakota?', correct_answer:'Pierre', wrong_answers:['Sioux Falls','Rapid City','Bismarck'] },
  { category:'geography', difficulty:'hard', question:'Accra is the capital of which country?', correct_answer:'Ghana', wrong_answers:['Nigeria','Ivory Coast','Senegal'] },
  { category:'geography', difficulty:'hard', question:'Which is the only U.S. state that borders just one other state?', correct_answer:'Maine', wrong_answers:['Vermont','Rhode Island','Delaware'] },
  { category:'geography', difficulty:'hard', question:'What is the longest river in the United Kingdom?', correct_answer:'The Severn', wrong_answers:['The Thames','The Trent','The Tay'] },
  { category:'geography', difficulty:'hard', question:'Into which body of water does the Jordan River empty?', correct_answer:'The Dead Sea', wrong_answers:['The Sea of Galilee','The Mediterranean Sea','The Red Sea'] },
  { category:'geography', difficulty:'hard', question:'The summit of Mount Everest lies on the border of Nepal and which country?', correct_answer:'China', wrong_answers:['India','Bhutan','Pakistan'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Slovenia?', correct_answer:'Ljubljana', wrong_answers:['Zagreb','Bratislava','Sarajevo'] },
  { category:'geography', difficulty:'hard', question:'Ushuaia, often called the southernmost city in the world, is in which country?', correct_answer:'Argentina', wrong_answers:['Chile','New Zealand','South Africa'] },
  { category:'geography', difficulty:'hard', question:'What is the second-longest river in Africa?', correct_answer:'The Congo', wrong_answers:['The Niger','The Zambezi','The Orange'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Croatia?', correct_answer:'Zagreb', wrong_answers:['Split','Dubrovnik','Belgrade'] },
  { category:'geography', difficulty:'hard', question:'The Mekong Delta is in which country?', correct_answer:'Vietnam', wrong_answers:['Cambodia','Thailand','Laos'] },
  { category:'geography', difficulty:'hard', question:'Which U.S. state has the most counties?', correct_answer:'Texas', wrong_answers:['Georgia','Kentucky','California'] },
  { category:'geography', difficulty:'hard', question:'The Cape of Good Hope is in which country?', correct_answer:'South Africa', wrong_answers:['Namibia','Mozambique','Madagascar'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of the Philippines?', correct_answer:'Manila', wrong_answers:['Quezon City','Cebu City','Davao City'] },
  { category:'geography', difficulty:'hard', question:'What is the capital of Albania?', correct_answer:'Tirana', wrong_answers:['Skopje','Podgorica','Pristina'] },
  { category:'geography', difficulty:'hard', question:'Which river carved the Grand Canyon?', correct_answer:'The Colorado River', wrong_answers:['The Green River','The Snake River','The Rio Grande'] },
  { category:'geography', difficulty:'hard', question:'Mount Nebo, where Moses viewed the Promised Land, is in which modern country?', correct_answer:'Jordan', wrong_answers:['Israel','Egypt','Syria'] },
];

const ALL_QUESTIONS = [...BIBLE_QUESTIONS, ...HISTORY_QUESTIONS, ...HISTORY_MORE, ...GEOGRAPHY_QUESTIONS, ...GEOGRAPHY_MORE];
