...
export const TUTORIALS = {
  ...
  train: [
    ...
    { emoji: '🔄', heading: 'Your Turn', body: 'Play one domino on your own train, the Mexican Train, or any train with a marker 🚩.\nDrag a domino onto a lit-up train to play it. Tap a domino to turn it round, and drag dominoes around your hand to plan your train — any time, even on other players\' turns.' },
